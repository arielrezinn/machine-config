cask "open-in-vs-code" do
  ...
  url "https://github.com/arielrezinn/machine-config/blob/12ba19f3644f8ea72a64d316614f68690b628b3e/finder-toolbar-applications/open-in-vscode/open-in-vs-code.dmg"
